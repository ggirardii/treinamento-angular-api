...
namespace Api
{
    public static class Musicas
    {
        ...
        public static List<MusicaDto> BuscarTodas() => Mapper.MapToDto(ListaMusicas);
        public static Musica BuscarPorId(int id) => ListaMusicas.FirstOrDefault(x => x.Id == id);
        public static List<MusicaDto> BuscarFavoritas() => Mapper.MapToDto(BuscarPorClassificacao(Classificacao.Favorita));
        public static List<MusicaDto> BuscarDaSemana() => Mapper.MapToDto(BuscarPorClassificacao(Classificacao.DaSemana));
